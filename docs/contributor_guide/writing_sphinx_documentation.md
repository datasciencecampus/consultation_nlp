...
Let us say that `consultation-nlp-2023/__init__.py` has functions called `hello` and `world` imported
into it, and both have docstrings. To automatically generate docstring documentation,
create a ReST file, and add the following line to reference the `consultation-nlp-2023` module:

```rest
.. currentmodule:: consultation-nlp-2023
```
...
Let us say that `consultation-nlp-2023/__init__.py` has functions called `hello` and `world` imported
into it, and both have docstrings. To automatically generate docstring documentation,
create a Markdown file, and add the following line to reference the `consultation-nlp-2023` module:
